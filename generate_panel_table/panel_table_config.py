...
class Panel_table_config():
    def __init__(self, data_date=None):
        ...
        jieba_score_input_dir = os.path.join(processed_date_dir, processing_version, 'features_data/jieba_score')
        bond_profile_input_dir = os.path.join(processed_date_dir, processing_version, 'features_data/bond_profile')
        
        panel_table_output_dir = os.path.join(processed_date_dir, processing_version, 'features_data/panel_table')
        
        # panel_table_total_output_dir = os.path.join()
        
        self.jieba_score_input_dir = os.path.join(jieba_score_input_dir, data_version)
        self.bond_profile_input_dir = os.path.join(bond_profile_input_dir, data_version)
        self.panel_table_output_dir = os.path.join(panel_table_output_dir, data_version)
        
if __name__ == '__main__':
    config = Panel_table_config()
